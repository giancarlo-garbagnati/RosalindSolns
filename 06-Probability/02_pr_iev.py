...
# Assuming two offspring per couple, this is the EV of dominant phenotype offspring per pair
couples_ev_pairs = [
    2, # AA-AA
    2, # AA-Aa
    2, # AA-aa
...
expected_dominant_pheno = 0
for i in range(0,len(couples_list)):
    expected_dominant_pheno += couples_list[i] * couples_ev_pairs[i]

print(expected_dominant_pheno)
